...
| `fecharJanelaProtocolo` | Fecha a janela do protocolo ao final da Fase 2 (`window.close()`). Se o navegador bloquear (janela não aberta por script), apenas registra `console.warn` — não navega para outra URL. |
